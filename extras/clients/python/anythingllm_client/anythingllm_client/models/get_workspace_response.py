...
class GetWorkspaceResponse(BaseModel):
    ...
    workspace: conlist(Workspace) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWorkspaceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWorkspaceResponse:
        """Create an instance of GetWorkspaceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWorkspaceResponse.parse_obj(obj)

        _obj = GetWorkspaceResponse.parse_obj(
            {
                "workspace": [
                    Workspace.from_dict(_item) for _item in obj.get("workspace")
                ]
