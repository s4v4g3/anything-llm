...
class InvalidAPIKey(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvalidAPIKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvalidAPIKey:
        """Create an instance of InvalidAPIKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvalidAPIKey.parse_obj(obj)

        _obj = InvalidAPIKey.parse_obj({"message": obj.get("message")})
        return _obj
