...
from anythingllm_client_asyncio import rest
...
from anythingllm_client_asyncio.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(anythingllm_client_asyncio.models, klass)
