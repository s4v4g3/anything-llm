# anythingllm_client_asyncio.DocumentsApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.DocumentsApi(api_client)
    body = 'body_example' # str | Name of the folder to create.

    try:
        api_response = await api_instance.create_document_folder(body)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_accepted_file_types()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_document(doc_name)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_document_metadata_schema()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_documents_by_folder(folder_name)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_documents()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.move_document_files(body)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anythingllm_client_asyncio.DocumentsApi(api_client)
    remove_document_folder_request = anythingllm_client_asyncio.RemoveDocumentFolderRequest() # RemoveDocumentFolderRequest | Name of the folder to remove.

    try:
        api_response = await api_instance.remove_document_folder(remove_document_folder_request)
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.upload_document200_response import UploadDocument200Response
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    metadata = anythingllm_client_asyncio.UploadDocumentRequestMetadata() # UploadDocumentRequestMetadata |  (optional)

    try:
        api_response = await api_instance.upload_document(file, add_to_workspaces=add_to_workspaces, metadata=metadata)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.upload_document_link(body)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.upload_document_raw_text(body)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.upload_document_to_folder(folder_name, file, add_to_workspaces=add_to_workspaces, metadata=metadata)
