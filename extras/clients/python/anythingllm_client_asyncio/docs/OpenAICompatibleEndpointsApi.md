# anythingllm_client_asyncio.OpenAICompatibleEndpointsApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.OpenAICompatibleEndpointsApi(api_client)

    try:
        await api_instance.openai_chat_completions()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.openai_create_embeddings()
    except Exception as e:
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.openai_list_models()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.openai_list_vector_stores()
