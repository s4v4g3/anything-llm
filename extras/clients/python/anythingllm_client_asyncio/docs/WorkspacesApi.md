# anythingllm_client_asyncio.WorkspacesApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.WorkspacesApi(api_client)
    slug = 'slug_example' # str | 

    try:
        api_response = await api_instance.chat_with_workspace(slug)
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.create_workspace_request import CreateWorkspaceRequest
from anythingllm_client_asyncio.models.create_workspace_response import CreateWorkspaceResponse
from anythingllm_client_asyncio.rest import ApiException
from pprint import pprint
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anythingllm_client_asyncio.WorkspacesApi(api_client)
    create_workspace_request = anythingllm_client_asyncio.CreateWorkspaceRequest() # CreateWorkspaceRequest | JSON object containing workspace configuration.
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_workspace(slug)
    except Exception as e:
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.get_workspace_response import GetWorkspaceResponse
from anythingllm_client_asyncio.rest import ApiException
from pprint import pprint
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace(slug)
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.get_workspace_chats_response import GetWorkspaceChatsResponse
from anythingllm_client_asyncio.rest import ApiException
from pprint import pprint
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace_chats(slug, api_session_id=api_session_id, limit=limit, order_by=order_by)
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.list_workspaces_response import ListWorkspacesResponse
from anythingllm_client_asyncio.rest import ApiException
from pprint import pprint
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_workspaces()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.stream_chat_with_workspace(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.WorkspacesApi(api_client)
    slug = 'slug_example' # str | Unique slug of workspace to find
    update_workspace_request = anythingllm_client_asyncio.UpdateWorkspaceRequest() # UpdateWorkspaceRequest | JSON object containing new settings to update a workspace. All keys are optional and will not update unless provided

    try:
        api_response = await api_instance.update_workspace(slug, update_workspace_request)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_workspace_embeddings(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_workspace_pin(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.vector_search_workspace(slug)
