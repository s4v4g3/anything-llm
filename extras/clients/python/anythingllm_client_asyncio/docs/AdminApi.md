# anythingllm_client_asyncio.AdminApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.AdminApi(api_client)

    try:
        api_response = await api_instance.create_invite()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.create_user()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.deactivate_invite(id)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace_users(workspace_id)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.is_multi_user_mode()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_invites()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_users()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.list_workspace_chats()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.manage_workspace_users(workspace_slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_admin_preferences()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_user(id)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_workspace_users(workspace_id)
