# anythingllm_client_asyncio.WorkspaceHierarchyApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.WorkspaceHierarchyApi(api_client)
    slug = 'slug_example' # str | Unique slug of the workspace to get breadcrumbs for

    try:
        api_response = await api_instance.get_workspace_breadcrumbs(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace_children(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace_subtree(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_workspace_tree()
