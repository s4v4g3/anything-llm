# anythingllm_client_asyncio.WorkspaceThreadsApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.WorkspaceThreadsApi(api_client)
    slug = 'slug_example' # str | Unique slug of workspace
    thread_slug = 'thread_slug_example' # str | Unique slug of thread

    try:
        api_response = await api_instance.chat_with_thread(slug, thread_slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.create_thread(slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.delete_thread(slug, thread_slug)
    except Exception as e:
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_thread_chats(slug, thread_slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.stream_chat_with_thread(slug, thread_slug)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_thread(slug, thread_slug)
