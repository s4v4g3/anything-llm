# anythingllm_client_asyncio.SystemSettingsApi
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = anythingllm_client_asyncio.SystemSettingsApi(api_client)
    type = 'type_example' # str | Export format jsonl, json, csv, jsonAlpaca (optional)

    try:
        api_response = await api_instance.export_chats(type=type)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.export_environment()
    except Exception as e:
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_system_settings()
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.get_vector_count()
...
import os
import anythingllm_client_asyncio
from anythingllm_client_asyncio.models.remove_documents_request import RemoveDocumentsRequest
from anythingllm_client_asyncio.rest import ApiException
from pprint import pprint
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anythingllm_client_asyncio.SystemSettingsApi(api_client)
    remove_documents_request = anythingllm_client_asyncio.RemoveDocumentsRequest() # RemoveDocumentsRequest | Array of document names to be removed permanently.

    try:
        api_response = await api_instance.remove_documents(remove_documents_request)
...
async with anythingllm_client_asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_system_settings()
